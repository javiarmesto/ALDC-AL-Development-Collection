<!-- ALDC Core Template — IMMUTABLE. Do NOT edit this file directly.
     Copy to {plans.root}/{req_name}/{req_name}.architecture.md and fill in. -->
...
Keep single-spec at `{plans.root}/{req_name}/{req_name}.spec.md`. Multi-spec files
share that same requirement directory, e.g.
`{plans.root}/{req_name}/{req_name}.spec-01-policy.spec.md`. Preserve existing
