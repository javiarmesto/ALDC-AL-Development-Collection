...
| **Tools** | Analysis + subagent delegation tool | Analysis only |
...
**Documentation-Driven**: **ALWAYS create `.github/plans/{req_name}/{req_name}.architecture.md`** immediately after user approves your architectural design. This is MANDATORY, not optional. COPY from `.agents/skills/aldc/references/templates/architecture-template.md` — **MUST NOT** edit templates directly.
...
1. **COPY** `.agents/skills/aldc/references/templates/architecture-template.md` → `.github/plans/{req_name}/{req_name}.architecture.md` (kebab-case, e.g., `.github/plans/customer-loyalty/customer-loyalty.architecture.md`)
...
You (al-architect):
[COPY .agents/skills/aldc/references/templates/architecture-template.md → .github/plans/customer-loyalty/customer-loyalty.architecture.md]
...
2. **IMPORTANT: Automatically create `.github/plans/{req_name}/{req_name}.architecture.md`** after user approves design:
   - COPY from `.agents/skills/aldc/references/templates/architecture-template.md` (never edit template)
...
Read [the BCQuality design guidance](../templates/bcquality-design-guidance.md)
...
**MANDATORY**: COPY `.agents/skills/aldc/references/templates/architecture-template.md` → `.github/plans/{req_name}/{req_name}.architecture.md`, then populate.
...
**MUST NOT** edit `.agents/skills/aldc/references/templates/architecture-template.md` directly — templates are immutable.
