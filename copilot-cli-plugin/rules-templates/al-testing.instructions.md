---
applyTo: '**/test/**/*.al'
description: AL Testing & Project Structure Rules - Ensure proper project organization and test implementation. ALDC always-on AL micro-rules (instruction al-testing); path-scoped.
