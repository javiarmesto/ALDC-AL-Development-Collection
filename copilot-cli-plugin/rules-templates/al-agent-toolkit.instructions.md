...
description: AL Agent Toolkit / BC Agents Pack — non-negotiable rules for code involving the AI Development Toolkit or Agent SDK. ALDC always-on AL micro-rules (instruction al-agent-toolkit); path-scoped.
