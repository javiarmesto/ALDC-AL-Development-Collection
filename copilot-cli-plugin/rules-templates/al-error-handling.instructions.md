---
applyTo: '**/*.Codeunit.al'
description: AL Error handling patterns, debugging techniques, and troubleshooting guidelines for AL development. ALDC always-on AL micro-rules (instruction al-error-handling); path-scoped.
