...
description: Performance optimization guidelines and best practices for AL development. ALDC always-on AL micro-rules (instruction al-performance); path-scoped.
