...
[the design guidance](${PLUGIN_ROOT}/docs/templates/bcquality-design-guidance.md) — and leave
...
1. Resolve the ALDC content root used by this host. Canonical checkout paths are
   `instructions/`, `skills/`, `${PLUGIN_ROOT}/docs/templates/`; installed Chat usually places
...
Instruction directory: `${PLUGIN_ROOT}/rules-templates/`. Domain entrypoints:
`${PLUGIN_ROOT}/skills/skill-events/SKILL.md`, `${PLUGIN_ROOT}/skills/skill-permissions/SKILL.md`,
`${PLUGIN_ROOT}/skills/skill-testing/SKILL.md`, `${PLUGIN_ROOT}/skills/skill-pages/SKILL.md`,
`${PLUGIN_ROOT}/skills/skill-performance/SKILL.md`, `${PLUGIN_ROOT}/skills/skill-api/SKILL.md`,
`${PLUGIN_ROOT}/skills/skill-copilot/SKILL.md`.
...
Use [the spec template](${PLUGIN_ROOT}/docs/templates/spec-template.md) as the section scaffold.
