...
| **Tools** | Analysis + agent tool | Analysis only |
...
### AL-Specific Analysis Tools (Copilot CLI harness)
...
- **Repository Context**: use `execute: git log` / `git diff` (and `web` for public repos) to understand development history and team patterns
