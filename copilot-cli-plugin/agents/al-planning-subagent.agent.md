...
- `repository files/history through available read tools` - Understand development history and team patterns
...
When you complete your research, return findings by reading and filling `${PLUGIN_ROOT}/docs/templates/planning-findings-template.md`. Do not invent the format inline; the template is the single source of truth.
