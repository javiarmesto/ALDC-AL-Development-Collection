...
Read [the provider contract](${PLUGIN_ROOT}/docs/templates/bcquality-provider-contract.md)
and [task-context guidance](${PLUGIN_ROOT}/docs/templates/bcquality-task-context.md).
...
Use [the shared review report](${PLUGIN_ROOT}/docs/templates/review-report-contract.md)
