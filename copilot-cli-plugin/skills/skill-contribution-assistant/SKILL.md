...
- `${PLUGIN_ROOT}/skills/<skill-name>/AUTHORS.md`
- `${PLUGIN_ROOT}/skills/<skill-name>/CHANGELOG.md`
- `${PLUGIN_ROOT}/skills/<skill-name>/references/` (optional, preferred for long content)
- `${PLUGIN_ROOT}/skills/<skill-name>/scripts/` (optional, only when deterministic automation helps)
