...
[the design guidance](${CLAUDE_PLUGIN_ROOT}/docs/templates/bcquality-design-guidance.md) — and leave
...
1. Resolve the ALDC content root used by this host. Canonical checkout paths are
   `instructions/`, `skills/`, `${CLAUDE_PLUGIN_ROOT}/docs/templates/`; installed Chat usually places
...
Instruction directory: `${CLAUDE_PLUGIN_ROOT}/rules/`. Domain entrypoints:
`${CLAUDE_PLUGIN_ROOT}/skills/skill-events/SKILL.md`, `${CLAUDE_PLUGIN_ROOT}/skills/skill-permissions/SKILL.md`,
`${CLAUDE_PLUGIN_ROOT}/skills/skill-testing/SKILL.md`, `${CLAUDE_PLUGIN_ROOT}/skills/skill-pages/SKILL.md`,
`${CLAUDE_PLUGIN_ROOT}/skills/skill-performance/SKILL.md`, `${CLAUDE_PLUGIN_ROOT}/skills/skill-api/SKILL.md`,
`${CLAUDE_PLUGIN_ROOT}/skills/skill-copilot/SKILL.md`.
...
Use [the spec template](${CLAUDE_PLUGIN_ROOT}/docs/templates/spec-template.md) as the section scaffold.
