...
- `${CLAUDE_PLUGIN_ROOT}/skills/<skill-name>/AUTHORS.md`
- `${CLAUDE_PLUGIN_ROOT}/skills/<skill-name>/CHANGELOG.md`
- `${CLAUDE_PLUGIN_ROOT}/skills/<skill-name>/references/` (optional, preferred for long content)
- `${CLAUDE_PLUGIN_ROOT}/skills/<skill-name>/scripts/` (optional, only when deterministic automation helps)
