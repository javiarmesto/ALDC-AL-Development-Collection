...
tools: Read, Glob, Grep, LSP, Write, Edit, WebSearch, WebFetch, mcp__al-symbols-mcp__*, mcp__plugin_aldc_al-symbols-mcp__*, mcp__context7__*, mcp__plugin_aldc_context7__*, mcp__microsoft-docs__*, mcp__plugin_aldc_microsoft-docs__*, mcp__al__al_symbolsearch, mcp__al__al_getdiagnostics, mcp__al__al_getpackagedependencies
model: sonnet
color: cyan
---

> **Claude Code adapter — generated by `scripts/sync-plugin-support.js`, do not edit.**
> Canonical source: `agents/al-spec-agent.agent.md` (sha256 `5d506ba504e80bfe1fd66b1047c3be98adf0b90702fad63273a072c92db26b3d`).
...
`.claude/plans/{req_name}/{req_name}.spec.md`. Preserve the existing filename
...
[the design guidance](${CLAUDE_PROJECT_DIR}/claude-plugin/docs/templates/bcquality-design-guidance.md) — and leave
...
1. Resolve the ALDC content root used by this host. Canonical checkout paths are
   `instructions/`, `skills/`, `${CLAUDE_PROJECT_DIR}/claude-plugin/docs/templates/`; installed Chat usually places
...
Instruction directory: `${CLAUDE_PROJECT_DIR}/.claude/rules/`. Domain entrypoints:
`${CLAUDE_PROJECT_DIR}/.claude/skills/skill-events/SKILL.md`, `${CLAUDE_PROJECT_DIR}/.claude/skills/skill-permissions/SKILL.md`,
`${CLAUDE_PROJECT_DIR}/.claude/skills/skill-testing/SKILL.md`, `${CLAUDE_PROJECT_DIR}/.claude/skills/skill-pages/SKILL.md`,
`${CLAUDE_PROJECT_DIR}/.claude/skills/skill-performance/SKILL.md`, `${CLAUDE_PROJECT_DIR}/.claude/skills/skill-api/SKILL.md`,
`${CLAUDE_PROJECT_DIR}/.claude/skills/skill-copilot/SKILL.md`.
...
Use [the spec template](${CLAUDE_PROJECT_DIR}/claude-plugin/docs/templates/spec-template.md) as the section scaffold.
