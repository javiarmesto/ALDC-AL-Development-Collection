...
- `${CLAUDE_PROJECT_DIR}/.claude/skills/<skill-name>/SKILL.md`
- `${CLAUDE_PROJECT_DIR}/.claude/skills/<skill-name>/AUTHORS.md`
- `${CLAUDE_PROJECT_DIR}/.claude/skills/<skill-name>/CHANGELOG.md`
- `${CLAUDE_PROJECT_DIR}/.claude/skills/<skill-name>/references/` (optional, preferred for long content)
- `${CLAUDE_PROJECT_DIR}/.claude/skills/<skill-name>/scripts/` (optional, only when deterministic automation helps)
