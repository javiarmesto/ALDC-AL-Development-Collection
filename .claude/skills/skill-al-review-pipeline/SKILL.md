...
Read [the provider contract](${CLAUDE_PROJECT_DIR}/claude-plugin/docs/templates/bcquality-provider-contract.md)
and [task-context guidance](${CLAUDE_PROJECT_DIR}/claude-plugin/docs/templates/bcquality-task-context.md).
...
Use [the shared review report](${CLAUDE_PROJECT_DIR}/claude-plugin/docs/templates/review-report-contract.md)
