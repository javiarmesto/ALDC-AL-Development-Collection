...
Read `${CLAUDE_PROJECT_DIR}/claude-plugin/agents/al-triage.md` in full and act as that agent for the rest of this session. The Copilot-to-Claude Code mappings at the top of that file are binding.
