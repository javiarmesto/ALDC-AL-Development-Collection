...
4. **Knowledge (optional, cited)** — select the configured **BCQuality** plugin or multiroot provider; if an actual review returns findings, fold cited findings into the diagnosis. Degrades gracefully when absent.
