...
function expected(root = ROOT) {
  ...
  sources.push(...walk(root,'tools/context-doctor'),'scripts/sync-plugin-support.js','scripts/install-transaction.js','scripts/init-plugin.js','scripts/sync-copilot-cli.js','docs/templates/memory-template.md');
